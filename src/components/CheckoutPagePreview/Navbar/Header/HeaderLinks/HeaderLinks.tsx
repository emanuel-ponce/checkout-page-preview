...
function HeaderLinks({ t }: WithTranslation) {
  return (
    <div className="flex items-center">
      <a href="https://dashboard.stripe.com/register" target="_blank" className="mr-3 text-blue font-semibold">
        {t('HEADER_LINKS.CREATE_ACCOUNT')}
      </a>
      <div className="ml-[2px] mr-3 border-r-[1px] h-[20px] border-r-slate"></div>
      <a href="https://docs.stripe.com/checkout/quickstart" target="_blank" className="flex items-center gap-3">
        <span className="text-blue font-semibold">{t('HEADER_LINKS.DOCS')}</span>
